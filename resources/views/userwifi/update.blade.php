@extends('layouts.app')
@section('title', 'USER HOTSPOT | EDIT')
@section('content')
        ...
        <div class="card-body">
          <div class="animate__animated animate__lightSpeedInLeft" align="right">
        	...
        	<div class="mb-3 animate__animated animate__fadeInUp" hidden>
				...
				<input required="required" type="text" class="form-control" name="id" name="id" value="{{$data->id}}" readonly style="cursor: not-allowed;">
				<p class="help-block" align="right">{{ $errors->first('id') }}</p>
			</div>

          <div class="mb-3 animate__animated animate__fadeInUp" hidden>
				<label class="form-label" for="no_urut">Nomor</label>
				<input required="required" type="text" class="form-control" name="no_urut"  value="{{ substr($data->id, -3, 6) }}" readonly style="cursor: not-allowed;">
        	...
        	<div class="mb-3 animate__animated animate__fadeInUp">
				...
				<div class="input-group mb-3">
					...
					<input required="required" type="text" class="form-control putRumah" style="background-color:#e9ecef;cursor:not-allowed" name="id_rumah" value="{{$data->id_rumah}}" placeholder="ID rumah" autocomplete="off" readonly>
				</div>
        	...
        	<div class="mb-3 animate__animated animate__fadeInUp">
				...
				<div class="input-group mb-3">
					...
					<input required="required" type="text" class="form-control putPaket" value="{{$data->id_paket}}" style="background-color:#e9ecef;cursor:not-allowed" name="id_paket" placeholder="ID Paket" autocomplete="off" readonly>
				</div>
			...
			<div class="mb-3 animate__animated animate__fadeInUp">
				<div class="input-group mb-3">
					...
					<input required="required" type="text" class="form-control" value="{{$data->username}}" name="username" placeholder="Username">
				</div>
			...
			<div class="mb-3 animate__animated animate__fadeInUp">
				<div class="input-group mb-3">
					...
					<input required="required" type="password" class="form-control" value="{{$data->password}}" name="password" placeholder="Password">
				</div>
			...
			<div class="mb-3 animate__animated animate__fadeInUp">
				<div class="input-group mb-3">
					...
					<input required="required" type="text" class="form-control mikrotik_date" value="{{$data->tgl_habis}}" name="tgl_habis" placeholder="Tanggal Kadaluarsa">
				</div>
			...
			<div class="mb-3 animate__animated animate__fadeInUp">
				<div class="input-group mb-3">
					...
					<input required="required" type="text" class="form-control mikrotik_date" value="{{$data->tgl_bayar}}" name="tgl_bayar" placeholder="Tanggal pembayaran terakhir">
				</div>
          ...
          <div class="mb-3 animate__animated animate__fadeInUp" hidden>
					  <label class="form-label" for="created_at">Dibuat</label>
						...
						?>
					  <input type="text" class="form-control" name="created_at" placeholder="{{ $datetimenow }}" value="{{$data->created_at}}" >
