          ...
          <div class="card-title">
            ...
            <div class="card-body">
              ...
              <div class="animate__animated animate__lightSpeedInRight" align="left">
                  <h2>
                    <a class="btn btn-primary" href="{{asset('datarumah/create')}}"><i class="material-icons">add_circle</i> Add</a>
                  </h2>
              </div>
                ...
                <table id="myTable" striped bordered hover variant="dark">
                  <tr class="header">
                    ...
                    <th class="animate__animated animate__lightSpeedInLeft">Nama Rumah</th>
                    <th class="animate__animated animate__lightSpeedInLeft">Alamat</th>
                    <th class="animate__animated animate__lightSpeedInLeft">No. Hp</th>
                    <th class="animate__animated animate__lightSpeedInLeft">NIK</th>
                    <th class="animate__animated animate__lightSpeedInLeft">NPWP</th>
                  ...
                  ?>
                    <tr class="<?php echo$color_stats ?>">
                        <td class="animate__animated animate__fadeInUp">{{ $x->nama_rumah }}</td>
                        <td class="animate__animated animate__fadeInUp">{{ $x->alamat }}</td>
                        <td class="animate__animated animate__fadeInUp">{{ $x->nomor_hp }}</td>
                        <td class="animate__animated animate__fadeInUp">{{ $x->NIK }}</td>
                        <td class="animate__animated animate__fadeInUp">{{ $x->NPWP }}</td>
                        <td class="animate__animated animate__fadeInUp">
                          <div class="btn-group">
                            <a class="btn btn-primary" href="{{asset('datarumah/'.$x->id.'/edit')}}"><i class="material-icons">update</i> Update</a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    Apakah kamu ingin menghapus <b>Rumah {{$x->nama_rumah}}</b>?
                                  </div>

                                  <!-- Modal footer -->
                                  <div class="modal-footer">
                                    <a class="btn btn-default" href="{{asset('datarumah/'.$x->id.'/del')}}">Ya</a>
