@extends('layouts.app')
@section('title', 'DATA RUMAH | Tambah')
@section('content')
	...
	<div class="container">
        ...
        <div class="card-body">
          ...
          <div class="mb-3 animate__animated animate__fadeInUp" hidden>
					  ...
					  <input required="required" type="text" class="form-control" name="no_urut"  value="{{ substr($autokode, -6, 6) }}" readonly style="cursor: not-allowed;">
        	...
        	<div class="mb-3 animate__animated animate__fadeInUp">
					  ...
					  <input required="required" type="text" class="form-control uppercase" name="nama_rumah" placeholder="" autocomplete="off">
					  <p class="help-block" align="right">{{ $errors->first('nama_rumah') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="alamat">Alamat</label>
					  <input required="required" type="text" class="form-control" name="alamat" placeholder="Kp. ..... RT. .../... Desa ........ Kecamatan ......... Kabupaten ......">
					  <p class="help-block" align="right">{{ $errors->first('alamat') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="nomor_hp">Nomor HP</label>
					  <input required="required" type="number" class="form-control" name="nomor_hp" placeholder="628xxxxxxxxxx">
          ...
          <div class="mb-3 animate__animated animate__fadeInUp">
					  ...
					  <input required="required" type="text" class="form-control" name="penanggungjawab" placeholder="">
					  <p class="help-block" align="right">{{ $errors->first('penanggungjawab') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="nik">NIK</label>
					  <input required="required" type="number" class="form-control" name="nik" placeholder="">
					  <p class="help-block" align="right">{{ $errors->first('nik') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="npwp">NPWP</label>
					  <input required="required" type="number" class="form-control" name="npwp" placeholder="">
					  <p class="help-block" align="right">{{ $errors->first('npwp') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="latitude">Latitude</label>
					  <input type="text" class="form-control" name="latitude" placeholder="" value="-">
					  <p class="help-block" align="right">{{ $errors->first('latitude') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="longitude">Longitude</label>
					  <input type="text" class="form-control" name="longitude" placeholder="" value="-">
