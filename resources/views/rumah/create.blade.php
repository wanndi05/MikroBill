        ...
        <div class="card-body">
          ...
          <div class="mb-3 animate__animated animate__fadeInUp" hidden>
        	...
        	<div class="mb-3 animate__animated animate__fadeInUp">
					  <input required="required" type="text" class="form-control uppercase" name="nama_rumah" placeholder="Nama Rumah" autocomplete="off">
          ...
          <div class="mb-3 animate__animated animate__fadeInUp">
					  ...
					  <input required="required" type="text" class="form-control" name="penanggungjawab" placeholder="Nama Penanggungjawab">
					  <p class="help-block" align="right">{{ $errors->first('penanggungjawab') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="nik">NIK</label>
					  <input required="required" type="number" class="form-control" name="nik" placeholder="NIK">
					  <p class="help-block" align="right">{{ $errors->first('nik') }}</p>
					</div>

          <div class="mb-3 animate__animated animate__fadeInUp">
					  <label class="form-label" for="npwp">NPWP</label>
					  <input required="required" type="number" class="form-control" name="npwp" placeholder="NPWP">
          ...
          <div class="mb-3 animate__animated animate__fadeInUp">
					  ...
					  <input type="text" class="form-control" name="longitude" placeholder="Longitude" value="-">
