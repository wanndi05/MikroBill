				...
				<hr>
					...
					<div class="mb-3 animate__animated animate__fadeInUp">
						<label class="form-label" for="id_paket">ID Paket</label>
							...
							<input required="required" type="text" class="form-control putPaket" style="background-color:#e9ecef;cursor:not-allowed" name="id_paket" placeholder="&#128274;" autocomplete="off" readonly>
