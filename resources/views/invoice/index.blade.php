          ...
          <div class="card-title">
            ...
            <div class="card-body">
              ...
              <div class="animate__animated animate__lightSpeedInRight" align="left">
                  <h2>
                    <a class="btn btn-primary" href="{{asset('invoice/create')}}"><i class="material-icons">add_circle</i> Add</a>
                  </h2>
              </div>
                ...
                <table id="myTable" striped bordered hover variant="dark">
                  <tr class="header">
                    ...
                    <th class="animate__animated animate__lightSpeedInLeft">Tgl. Habis</th>
                    <th class="animate__animated animate__lightSpeedInLeft">Tgl. Bayar</th>
                    <th class="animate__animated animate__lightSpeedInLeft">Harga</th>
                    <th class="animate__animated animate__lightSpeedInLeft">Harga Seller</th>
                    <th class="animate__animated animate__lightSpeedInLeft">Track Bill</th>
                    <th class="animate__animated animate__lightSpeedInLeft">Status</th>
                  ...
                  ?>
                    <tr class="<?php echo$color_stats ?>">
                        ...
                        <td class="animate__animated animate__fadeInUp">{{ $x->track_bill }}</td>
                        <td class="animate__animated animate__fadeInUp">{{ $x->status }}</td>
                        <td class="animate__animated animate__fadeInUp">
                          <div class="btn-group">
                            <a class="btn btn-primary" href="{{asset('invoice/'.$x->id.'/edit')}}"><i class="material-icons">update</i> Update</a>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <a class="btn btn-default" href="{{asset('invoice/'.$x->id.'/del')}}">Ya</a>
